def get_key_status_color(status):
    """Return color code for key status for UI highlighting."""
    color_map = {
        "Còn hạn": "#43a047",      # Green
        "Gần hết hạn": "#ffa000",  # Orange
        "Hết hạn": "#e53935",      # Red
        "Revoked": "#616161"       # Grey
    }
    return color_map.get(status, "#1976d2")  # Default blue
import json
